...
1. A Flame cluster running (see [Getting Started](/docs/getting-started/))
...
To get started with your own implementations, check out the complete [`examples/agents/scripts/main.py`](https://github.com/xflops/flame/blob/main/examples/agents/scripts/main.py) example and explore the [Flame documentation](/docs/overview/) for more advanced features and capabilities.
